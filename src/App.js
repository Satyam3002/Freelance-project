  ...
  return (<>
    ...
    <div className='screen'>
      ...
      <div id={first_half_layer} className='firsthalf'>
        ...
        <img className={top_p_text[3] === 'ABC 456' ? 'fadein' : 'fadeout'}  style={{width: '270px', marginLeft: '10%', marginTop: '55vh'}} alt='Layer 1 Full Height' src={l1_fh_img} />
        <p className={top_p_text[3] === 'ABC 456' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '15%', left: '50%', color: 'white', fontSize: '60px',marginBottom : '100px' }}> 25M+ Downloads</p>
        {top_p_text[3] === 'ABC 456' && <p style={{position: 'absolute', top: '60vh', left: '10%', color: 'white',fontSize:'60px',fontWeight:'bold'}}>ABC 123</p>}
        {top_p_text[3] === 'ABC 456' && <p style={{position: 'absolute', top: '80vh', left: '10%', color: 'white',fontSize:'15px',fontWeight:'bold'}}>We are the best web development <br/> company in the world</p>}
        
        <p className={top_p_text[3] === 'ABC 457' ? 'texteffectin1' : 'texteffectout1'} style={{position: 'absolute', top: '20vh', left: '50%', color: 'white',fontSize:'30px',}}>The Next Big</p>
        <p className={top_p_text[3] === 'ABC 457' ? 'texteffectin1' : 'texteffectout1'} style={{position: 'absolute', top: '28vh', left: '60%', color: 'white', fontSize: '60px'}}>Blockchain </p>
        <p className={top_p_text[3] === 'ABC 457' ? 'texteffectin1' : 'texteffectout1'} style={{position: 'absolute', marginTop: '20vh', left: '80%', color: 'white', fontSize: '30px'}}>Revolution</p>
        {top_p_text[3] === 'ABC 457' && <p style={{position: 'absolute', top: '60vh', left: '10%', color: 'white',fontSize:'60px',fontWeight:'bold'}}>ABC 123</p>}
        {top_p_text[3] === 'ABC 457' && <p style={{position: 'absolute', top: '80vh', left: '10%', color: 'white',fontSize:'15px',fontWeight:'bold'}}>We are the best web development <br/> company in the world</p>}



        {top_p_text[3] === 'ABC 458' && <p style={{position: 'absolute', top: '60vh', left: '10%', color: 'white',fontSize:'60px',fontWeight:'bold'}}>ABC 123</p>}
        {top_p_text[3] === 'ABC 458' && <p style={{position: 'absolute', top: '80vh', left: '10%', color: 'white',fontSize:'15px',fontWeight:'bold'}}>We are the best web development <br/> company in the world</p>}
        { top_p_text[3] === 'ABC 458' ? ( <>
        <p className="texteffectin" style={{ position: 'absolute', top: '22vh', left: '40%', color: 'white', fontSize: '30px' }}>Powered by advance</p>
        <p className="texteffectin" style={{ position: 'absolute', top: '25vh', left: '80%', color: 'white', fontSize: '45px',marginTop:'13vh' }}>NASA</p>
        <p className="texteffectin" style={{ position: 'absolute', top: '38vh', left: '80%', color: 'white', fontSize: '30px',marginTop:'25vh' }}>algorithms</p>
        </>
        ) : (
        <>
      <p className="texteffectout" style={{ position: 'absolute', top: '22vh', left: '45%', color: 'white', fontSize: '30px' }}>Redefining</p>
      <p className="texteffectout" style={{ position: 'absolute', top: '25vh', left: '45%', color: 'white', fontSize: '45px' }}>UX Strategy</p>
      <p className="texteffectout" style={{ position: 'absolute', top: '38vh', left: '60%', color: 'white', fontSize: '30px' }}>and UI design</p>
      </>
  )
}
      ...
      <p className="texteffectin" style={{ position: 'absolute', top: '22vh', left: '45%', color: 'white', fontSize: '30px' }}>Redefining</p>
      <p className="texteffectin" style={{ position: 'absolute', top: '25vh', left: '45%', color: 'white', fontSize: '45px',marginTop:'10vh' }}>UX Strategy</p>
      <p className="texteffectin" style={{ position: 'absolute', top: '38vh', left: '60%', color: 'white', fontSize: '30px',marginTop:'18vh' }}>and UI design</p>
       </>
     ) : (
     <>
      <p className="texteffectout" style={{ position: 'absolute', top: '22vh', left: '45%', color: 'white', fontSize: '30px' }}>Redefining</p>
      ...
      <p className="texteffectout" style={{ position: 'absolute', top: '38vh', left: '60%', color: 'white', fontSize: '30px' }}>and UI design</p>
        ...
        {top_p_text[3] === 'ABC 459' && <p style={{position: 'absolute', top: '60vh', left: '10%', color: 'white',fontSize:'60px',fontWeight:'bold'}}>ABC 123</p>}
        {top_p_text[3] === 'ABC 459' && <p style={{position: 'absolute', top: '80vh', left: '10%', color: 'white',fontSize:'15px',fontWeight:'bold'}}>We are the best web development <br/> company in the world</p>}
        
        {
  top_p_text[3] === 'ABC 4510' && (
    <>
      <p className={top_p_text[3] === 'ABC 4510' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '22vh', left: '45%', color: 'white', fontSize: '30px' }}>Text Headline</p>
      <p className={top_p_text[3] === 'ABC 4510' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '30vh', left: '45%', color: 'white', fontSize: '40px',marginTop:'14vh' }}>Text Headline</p>
      <p className={top_p_text[3] === 'ABC 4510' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '45vh', left: '50%', color: 'white', fontSize: '30px',marginTop:'25vh' }}>Footer Headline</p>
    </>
  )
}

        {top_p_text[3] === 'ABC 4510' && <p style={{position: 'absolute', top: '60vh', left: '10%', color: 'white',fontSize:'60px',fontWeight:'bold'}}>ABC 123</p>}
        {top_p_text[3] === 'ABC 4510' && <p style={{position: 'absolute', top: '80vh', left: '10%', color: 'white',fontSize:'15px',fontWeight:'bold'}}>We are the best web development <br/> company in the world</p>}


        { top_p_text[3] === 'ABC 4511' && ( <>
      <p className={top_p_text[3] === 'ABC 4511' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '22vh', left: '18%', color: 'white', fontSize: '30px' }}>Download ERP Solution For</p>
      <p className={top_p_text[3] === 'ABC 4511' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '30vh', left: '45%', color: 'white', fontSize: '40px',marginTop:'12vh' }}>Text Headline</p>
      <p className={top_p_text[3] === 'ABC 4511' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '45vh', left: '45%', color: 'white', fontSize: '30px',marginTop:'22vh' }}>in Future industry</p>
    </>
     )
}


        {top_p_text[3] === 'ABC 4511' && <p style={{position: 'absolute', top: '60vh', left: '10%', color: 'white',fontSize:'60px',fontWeight:'bold'}}>ABC 678</p>}
        {top_p_text[3] === 'ABC 4511' && <p style={{position: 'absolute', top: '80vh', left: '10%', color: 'white',fontSize:'15px',fontWeight:'bold'}}>Best since 2013 <br/>We offer wide range of <br/>Web development and app development</p>} 

      
    <img className={top_p_text[3] === 'ABC 4512' ? 'fadein' : 'fadeout'}  style={{width: '300px', marginLeft: '10%', marginTop: '50vh'}} alt='Layer 1 Full Height' src={l7fhimg} />
     { top_p_text[3] === 'ABC 4512' && ( <>
      <p className={top_p_text[3] === 'ABC 4512' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '22vh', left: '45%', color: 'white', fontSize: '30px' }}>Biggest Classifieds</p>
      <p className={top_p_text[3] === 'ABC 4512' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '30vh', left: '%', color: 'white', fontSize: '40px',marginTop:'12vh' }}>East Asia </p>
      <p className={top_p_text[3] === 'ABC 4512' ? 'texteffectin' : 'texteffectout'} style={{ position: 'absolute', top: '45vh', left: '45%', color: 'white', fontSize: '30px',marginTop:'22vh' }}>Countries</p>
    </> )
}       
       
        {top_p_text[3] === 'ABC 4512' && <p style={{position: 'absolute', top: '60vh', left: '10%', color: 'white',fontSize:'60px',fontWeight:'bold'}}>ABC 23478</p>}
        {top_p_text[3] === 'ABC 4512' && <p style={{position: 'absolute', top: '80vh', left: '10%', color: 'white',fontSize:'15px',fontWeight:'bold'}}>Best since 2013 <br/>We offer wide range of <br/>Web development and app development</p>} 
      ...
      <div id={second_half_layer} className='secondhalf'>
          <img className={top_p_text[3] === 'ABC 456' ? 'l1sheffectin' : 'l1sheffectout'} style={{marginLeft: '240px', position: 'absolute',height:'80vh'}} alt='mobile img 1' src={l1_sh_img1}/>
          <img className={top_p_text[3] === 'ABC 456' ? 'l1sheffectin' : 'l1sheffectout'} style={{marginLeft: '550px', position: 'absolute',height:'80vh'}} alt='mobile img 2' src={l1_sh_img2}/>
          <img className={top_p_text[3] === 'ABC 457' ? 'l2shimg1effectin' : 'l2shimg1effectout'} style={{marginLeft: '305px', position: 'absolute',width:'50vh',height:'70vh'}} alt='mobile img 1' src={l2shimg1}/>
          <img className={top_p_text[3] === 'ABC 457' ? 'l2shimg2effectin' : 'l2shimg2effectout'} style={{marginLeft: '670px', position: 'absolute',width:'50vh',height:'70vh'}} alt='mobile img 2' src={l2shimg2}/>
          <img className={top_p_text[3] === 'ABC 458' ? 'l3shimg1effectin' : 'l3shimg1effectout'} style={{marginLeft: '300px', position: 'absolute',width:'50vh',height:'75vh'}} alt='mobile img 1' src={l3shimg1}/>
          <img className={top_p_text[3] === 'ABC 458' ? 'l3shimg2effectin' : 'l3shimg2effectout'} style={{marginLeft: '700px', position: 'absolute',width:'40vh',height:'70vh',marginTop: '190px'}} alt='mobile img 2' src={l3shimg2}/>
         
          <img className={top_p_text[3] === 'ABC 459' ? 'l4shimg1effectin' : 'l4shimg1effectout'} style={{marginLeft: '290px', height:'60vh', position: 'absolute'}} alt='mobile img 1' src={l4shimg1}/>
          <img className={top_p_text[3] === 'ABC 459' ? 'l4shimg2effectin' : 'l4shimg2effectout'} style={{marginLeft: '700px', position: 'absolute' , height:'60vh'}} alt='mobile img 2' src={l4shimg2}/>
          <img className={top_p_text[3] === 'ABC 459' ? 'l4shimgbuneffectin' : 'l4shimgbuneffectout'} style={{right: '80px', position: 'absolute', width: '150px', height: 'auto',marginTop:'90px'}} alt='mobile img 3' src={l4shimgbun}/>
          <img className={top_p_text[3] === 'ABC 459' ? 'l4shimgrolleffectin' : 'l4shimgrolleffectout'} style={{bottom: '-45px', position: 'absolute', width: '300px', height: 'auto'}} alt='mobile img 4' src={l4shimgroll}/>
          <img className={top_p_text[3] === 'ABC 459' ? 'l4shimgpizzaeffectin' : 'l4shimgpizzaeffectout'} style={{position: 'absolute', width: '550px', marginTop: '-125px'}} alt='mobile img 5' src={l4shimgpizza}/>
          <img className={top_p_text[3] === 'ABC 4510' ? 'l5shimg1effectin' : 'l5shimg1effectout'} style={{marginLeft: '150px', position: 'absolute',height:'60vh'}} alt='mobile img 1' src={l5shimg1}/>
          <img className={top_p_text[3] === 'ABC 4510' ? 'l5shimg2effectin' : 'l5shimg2effectout'} style={{marginLeft: '485px', position: 'absolute',height:'60vh'}} alt='mobile img 2' src={l5shimg2}/>
          <img className={top_p_text[3] === 'ABC 4510' ? 'l5shimg3effectin' : 'l5shimg3effectout'} style={{top: '22vh', position: 'absolute',height:'60vh'}} alt='mobile img 3' src={l5shimg3}/>
          <img className={top_p_text[3] === 'ABC 4510' ? 'l5shimg4effectin' : 'l5shimg4effectout'} style={{marginLeft: '485px', position: 'absolute',height:'60vh'}} alt='mobile img 4' src={l5shimg4}/>
          <img className={top_p_text[3] === 'ABC 4510' ? 'l5shimg5effectin' : 'l5shimg5effectout'} style={{marginLeft: '150px', position: 'absolute',height:'60vh'}} alt='mobile img 5' src={l5shimg5}/>  
          
          <img className={top_p_text[3] === 'ABC 4511' ? 'l6shimgeffectin' : 'l6shimgeffectout'} style={{position: 'absolute', height:'95%', width: '100%',marginLeft:'00px'}} alt='mobile img 1' src={l6shimg}/>  
          <img className={top_p_text[3] === 'ABC 4512' ? 'l7shimg2effectin' : 'l7shimg2effectout'} style={{marginLeft: '650px', position: 'absolute',height:'70vh',marginBottom:'35px'}} alt='mobile img 1' src={l7shimg2}/>  
          <img className={top_p_text[3] === 'ABC 4512' ? 'l7shimg1effectin' : 'l7shimg1effectout'} style={{marginLeft: '410px', position: 'absolute',height:'70vh',marginBottom:'50px'}} alt='mobile img 2' src={l7shimg1}/>  
      </div>
        ...
        <div class='item' style={{width: '100%'}}>
            ...
            <div style={{color: 'white', width: '100%', height: '50vh', backgroundColor: '#6343a2', position: 'absolute'}}>
                ...
                <img style={{marginTop: '-15px', width: '70%', backgroundColor:'white', border: '3px solid #6343a2', borderRadius: '15px'}} alt='img 1' src={l1_fh_img}/>
                {top_p_text[3] === 'ABC 456' && <p style={{position: 'absolute', top: '20vh', left: '22%', color: 'white',fontSize:'60px',}}>25M+ Downloads</p>}
